...
my $rrddb = "/home/nicu/rrd/ibm24_tf";
...
my @order = ( 236, 237, 238, 239, 30, 31, 33, 32, 35, 34, 36 );

my $pingcmd = "ping -c 4 ibm24";
my $ipmicmd = "ssh ibm24 sudo ipmi-sensors --comma-separated-output --no-header-output -r ";
